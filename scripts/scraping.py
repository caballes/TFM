...
def main(argv):
	...
	global lista
	global disease;
	asian_countries = ['AFG', 'ARM', 'AZE', 'BHR', 'BGD', 'BTN', 'CHN',
                       'CYP', 'KHM', 'TWN', 'GEO', 'HKG', 'IND', 'IDN',
                       'IRN', 'IRQ', 'ISR', 'JPN', 'JOR', 'KAZ', 'KOR',
                       'KWT', 'KGZ', 'LAO', 'LBN', 'MYS', 'MNG', 'MDV',
                       'MMR', 'PAK', 'NPL', 'OMN', 'PRK', 'PSE', 'PHL',
                       'QAT', 'RUS', 'SAU', 'SGP', 'LKA', 'SYR', 'TJK',
                       'TLS', 'THA', 'TUR', 'TKM', 'ARE', 'UZB', 'VNM',
                       'YEM']

	european_countries = ['ALB', 'DEU', 'AND', 'AUT', 'BEL', 'BLR', 'BIH',
                          'BGR', 'CYP', 'HRV', 'DNK', 'SVK', 'SVN', 'ESP',
                          'EST', 'FIN', 'FRA', 'GRC', 'HUN', 'IRL', 'ISL', 'ITA', 'LVA',
                          'LIE', 'LTU', 'LUX', 'MKD', 'MLT', 'MDA', 'MCO',
'MNE', 'NOR', 'NLD', 'POL', 'PRT', 'GBR', 'CZE', 'ROU',
                          'RUS', 'SMR', 'SRB', 'SWE', 'CHE', 'UKR', 'VAT']
